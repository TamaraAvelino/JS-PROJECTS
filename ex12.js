...
// function nome da função (propriedades: props){}
...
// console.log(calcularMedia(9, 9, 10))
...
// console.log(calcularMedia (alunos[2].notas[0], alunos[2].notas[1], alunos[2].notas[3]))

//laço de repetição para calcular a média de cada aluno
//length pega todos os objetos da lista e conta
// i = index 0, quando a função terminar vira 1, depois vira 2, assim em diante.
